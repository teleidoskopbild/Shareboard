...
export default function Settings() {
  ...
  const handleSaveUser = async (e) => {
    ...
    const oldUser = boardData.users.find((user) => user.id === editUserId);
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Bearbeitungszustand und Eingabefelder zurücksetzen
        setEditUserId(null);
        setEditUserName("");
        setEditUserEmail("");
      } else {
  ...
  return (
    <div className="dark:bg-gray-900 min-h-screen">
      <div className="p-4 md:p-8 max-w-screen-lg mx-auto dark:bg-gray-900 dark:text-gray-200">
        <div>
          <h1 className="text-3xl font-bold mb-4">{boardData.boardName}</h1>
                      ...
                      {user.email && (
                        <button
                          onClick={() => {
                            ...
                            alert(
                              `Successfully sent an invitation to ${user.name}`
                            );
                          }}
        ...
        {boardData.ownerKey === ownerKey && (
          <div className="border mt-8 bg-red-100 p-6 rounded-lg shadow-md dark:bg-gray-700 dark:border-red-500">
            ...
            {isDeleteMode ? (
              <>
                <p className="mb-4 dark:text-gray-200">
                  Are you sure you want to delete the entire board, including
                  all users and data?
                </p>
                <p className="mb-4 dark:text-gray-200">
                ...
                <input
                  ...
                  className=" flex w-1/3 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 mb-4 dark:text-gray-900"
              ...
              <button
                ...
                className="bg-red-500 text-white py-2 px-6 rounded-md hover:bg-red-600 transition duration-200 dark:text-gray"
              >
                Delete Board
              </button>
            )}
